...
describe("/", () => {
  ...
  describe("/api", () => {
    ...
    describe("/articles", () => {
      ...
      it("GET 404 when given an id that doesn't exist", () => {
        return request
    ...
    describe("/comments", () => {
      it("GET gives status 200 and returns an array of comments for the given article_id", () => {
        return request
      ...
      it("DELETE gives a status 204 and deletes the given comment by comment_id", () => {
        return request
          .delete("/api/comments/1")
          .expect(204)
          .then(() =>
            request.get("/api/comments").then(res => {
              expect(
    ...
    describe("/users", () => {
      ...
      it("GET gives a status 200 and returns a user object given an id number in it's parameter", () => {
        return request
